...
const SearchBar: React.FC<SearchBarProps> = ({ options, onSelect }) => {
  ...
  return (
    <div className="relative w-full" ref={searchRef}>
      <div className="relative app-background shadow-custom dark:shadow-none rounded-md min-w-[300px]">
        <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
          <SearchIcon className="text-neutral-500 dark:text-neutral-400" />
        </div>
        <input
          type="search"
          className="w-full py-2.5 px-3 pl-10 text-sm app-background text-neutral-900 dark:text-neutral-100 rounded-md border border-neutral-300 dark:border-neutral-600 placeholder-neutral-500 focus:outline-none"
